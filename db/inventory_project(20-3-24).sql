...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 02:20 PM
...
(3, 'Carl Evans', 'carlevans@example.com', '+12163547758', 'India', 'Gandhinagar', '1234 Elm Street', '1741861720_customer6.jpg', '2025-03-13 10:28:40');
...
(1, 'IMS', 'harshpatel120403@gmail.com', '6354177806', '2', 'Asia/Kolkata', 'd-m-Y', '1742367372_inventory-logo.png', '1740658494_favicon.png', '7 Street, Ahmedabad, Gujarat, 382481', '2025-03-19 06:56:12');
...
(2, 'samsung s23', 3, 8, 4, 2, 'PT002', 2, 19, 'The Samsung Galaxy S23 is a flagship smartphone released in 2023, featuring a 6.1-inch Dynamic AMOLED 2X display, a 50MP triple-camera system, and the powerful Snapdragon 8 Gen 2 processor.', 3, 'Cash', 8, 25000.00, '1739950963_mobile.jpg', '2025-03-20 13:15:07'),
...
(4, 'Iphone 14 Pro', 3, 12, 4, 2, 'PT003', 5, 21, 'Display · Super Retina XDR display · 6.1‑inch (diagonal) all‑screen OLED display · 2556x1179-pixel resolution at 460 ppi · Dynamic Island · Always-On display.', 3, 'Percentage', 10, 100000.00, '1740396298_iphone 14 pro.jpg', '2025-03-13 06:16:39');
...
(4, 'IMS-0004', 2, '13-03-2025', 203550.00, 4, 10000.00, 1000.00, 'Pending', 149050.00, 4, '2025-03-20 12:40:03');
...
(1, 4, 'samsung s23', 25000.00, 6, 150000.00),
...
CREATE TABLE `purchase_returns` (
  ...
  `paid_payment` decimal(10,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `purchase_returns` (`id`, `return_invoice`, `supplier_id`, `purchase_return_date`, `shipping`, `paid_payment`, `payment_type`, `updated_at`) VALUES
(1, 'IMS-0004', 2, '2025-03-13', 100.00, 24750.00, 3, '2025-03-20 13:15:07');
...
INSERT INTO `purchase_return_items` (`id`, `purchase_return_id`, `product_name`, `quantity`, `unit_price`, `discount`, `tax`, `subtotal`) VALUES
(6, 1, 'samsung s23', 1, 25000.00, 2500.00, 2250.00, 24750.00);
...
(15, 'INV-0014', 2, '07-03-2025', 5, 500.00, 100.00, 108600.00, 108600.00, '4', 'Inprogress', '2025-03-13 09:48:19'),
(16, 'INV-0015', 2, '07-03-2025', 3, 5000.00, 100.00, 42300.00, 30000.00, '4', 'Completed', '2025-03-10 06:52:41'),
(17, 'INV-0016', 3, '10-03-2025', 3, 2500.00, 50.00, 56550.00, 27050.00, '4', 'Inprogress', '2025-03-20 12:25:20'),
...
INSERT INTO `sale_return` (`id`, `return_invoice`, `customer_id`, `return_date`, `paid_payment`, `payment_type`, `updated_at`) VALUES
(1, 'INV-0017', 2, '13-03-2025', 117000.00, 4, '2025-03-17 12:40:57'),
(2, 'INV-0017', 2, '13-03-2025', 117000.00, 4, '2025-03-17 12:40:54'),
(3, 'INV-0016', 2, '13-03-2025', 56500.00, 3, '2025-03-20 13:11:36');
...
INSERT INTO `sale_return_items` (`id`, `sale_return_id`, `product_name`, `price`, `qty`, `discount`, `tax`, `subtotal`, `updated_at`) VALUES
(1, 1, 'Iphone 14 Pro', 100000.00, 1, 1000.00, 18000.00, 117000.00, '2025-03-13 06:16:17'),
(2, 2, 'Iphone 14 Pro', 100000.00, 1, 1000.00, 18000.00, 117000.00, '2025-03-13 06:16:39'),
(14, 3, 'samsung s23', 25000.00, 2, 2500.00, 9000.00, 56500.00, '2025-03-20 13:11:36');
...
ALTER TABLE `purchase_returns`
  ...
  ADD CONSTRAINT `purchase_returns_ibfk_2` FOREIGN KEY (`payment_type`) REFERENCES `payment_types` (`id`);

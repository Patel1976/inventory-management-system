...
function previewImage(e){var t=e.target,n=new FileReader;n.onload=function(){document.getElementById("imagePreview").src=n.result},t.files&&t.files[0]&&n.readAsDataURL(t.files[0])}
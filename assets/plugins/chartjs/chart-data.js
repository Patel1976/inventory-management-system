...
//     var ctx = document.getElementById('sales_purchase_charts').getContext('2d');
...
//             scales: {
//                 x: {
//                     stacked: false // Enables grouping instead of stacking
//                 },
//                 y: {
//                     beginAtZero: true
//                 }
...
//     var ctx = document.getElementById('top_product').getContext('2d');
//     var ctx = document.getElementById('top_product').getContext('2d');
//     var chartDonut = new Chart(ctx, {
//         type: 'doughnut', // Changed from 'pie' to 'doughnut'
//         data: {
//             labels: ['Macbook pro', 'Apple Earpods', 'iPhone 11', 'samsung', 'Dell Gaming Laptop'],
//             datasets: [{
//                 data: [40, 20, 15, 10, 15], // Update these values as needed
...
//             cutout: '60%', // Controls the hole size (Adjustable)
//             plugins: {
//                 legend: {
//                     position: 'bottom'
//                 }
...
document.addEventListener("DOMContentLoaded", function () {
    function loadChart(year) {
        fetch('fetch_chart_data.php?year=' + year)
            ...
            .then(data => {
                // Destroy old chart if needed (optional)
    ...
    // Load default current year chart

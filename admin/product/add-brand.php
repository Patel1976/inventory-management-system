        ...
        <form action="../../include/crud.php" method="POST" enctype="multipart/form-data">
            <div class="page-header">
                <div class="page-title">
                    <h4><?php echo $brand_id ? 'Update Brand' : 'Brand Add'; ?></h4>
                    <h6><?php echo $brand_id ? 'Update Selected Brand' : 'Create new Brand'; ?></h6>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="image-upload">
                                    <input type="file" name="brand_image" id="file" class="form-control"
                        ...
                        <div class="col-lg-12">
                            <input type="submit" name="<?php echo !empty($brand_id) ? 'update_brand' : 'add_brand'; ?>"
                                value="<?php echo !empty($brand_id) ? 'Update' : 'Submit'; ?>"
                                class="btn btn-submit me-2">
                            <input type="hidden" name="brand_id" value="<?php echo $brand_id; ?>">
                            <a href="brand-list.php" class="btn btn-cancel">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>

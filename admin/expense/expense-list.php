...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="add-expense.php" class="btn btn-added"><img
                        src="<?php echo SITE_URL; ?>assets/img/icons/plus.svg" class="me-2" alt="img">Add New
                    Expense</a>
            </div>
        </div>
        <div class="card">
                    ...
                    <table class="table  datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a class="me-3" href="edit-expense.php">

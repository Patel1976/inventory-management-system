...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="add-purchase-return.php" class="btn btn-added">
                    <img src="<?php echo SITE_URL; ?>assets/img/icons/plus.svg" alt="img" class="me-2">Add Purchase Return
                </a>
            </div>
        </div>
        <div class="card">
                    ...
                    <table class="table datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a class="me-3" href="edit-purchase-return.php">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="product-img">
                                        <img src="<?php echo SITE_URL; ?>assets/img/product/product10.jpg" alt="product">
                                    </a>
                                </td>
                                <td>3/24/2022</td>
                                <td>Best Power Tools</td>

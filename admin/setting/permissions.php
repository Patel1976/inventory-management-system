...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a class="btn btn-added" href="add-permission.php"><img
                        src="<?php echo SITE_URL; ?>assets/img/icons/plus.svg" alt="img" class="me-1">Add Group
                    Permission</a>
            </div>
        </div>
                    ...
                    <table class="table  datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="me-3" href="edit-permission.php">
